                ...
                <div class="msg">
                    ...
                    <div class="favorite">
                        <?php if ((int)$favorite_ref["COUNT(*)"] === 0) : ?>
                            ...
                            <div style="display: inline-block;"><span style="color:gray;"><?php
                        ...
                        <?php else : ?>
                            ...
                            <div style="display: inline-block;"><span style="color:red;"><?php
                                                                                            //RTされた投稿であれば、RT元のいいね数を表示
                                                                                            //RT元のいいね数
                                                                                            if ((int)$rt_fav_ref === 0) {
                                                                                                echo h((int)$favorite_count_rt["COUNT(*)"]);
